...
function Yoga() {
  ...
  const [userTimer, setUserTimer] = useState(30);
      ...
      <div className="yoga-container">
        ...
        <div className="performance-container">
          ...
          <div className="labeldata">
            <label>Target: {userTimer} s</label>
          </div>
        </div>
        <div>
          <Webcam
  ...
  return (
    <div className="yoga-container">
      <div className="home-header1">
        <Link to="/stats">
          <button className="btn btn-secondary" id="report-btn">
            REPORT
          </button>
        </Link>
        ...
        <Link to="/Login">
          <button className="btn btn-secondary" id="logout-btn">
            LOGOUT
          </button>
        </Link>
      </div>
      ...
      <button onClick={startYoga} className="secondary-btn start-pose-btn">
        Start Pose
      </button>
    </div>
  );
